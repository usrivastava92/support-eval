...
- `src/support_eval/guardrails.py` owns deterministic tool, policy, and post-repair guardrail checks.
- `src/support_eval/aggregate.py` owns deterministic failure-summary aggregation, including repair guardrail counters.
...
- Run deterministic repair guardrails after every generated repair and before review or publication.
- Treat a repair guardrail blocking finding as authoritative; no reviewer approval may override it.
