...
def build_prompt(stage: str, policy: str, tool_specs: dict[str, Any], case: dict[str, Any] | None = None, evaluation: dict[str, Any] | None = None, guardrail: dict[str, Any] | None = None, repair: dict[str, Any] | None = None) -> str:
    schemas = {
