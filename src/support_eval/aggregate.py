...
def build_failure_summary(evaluations: list[dict], guardrails: list[dict], repairs: list[dict]) -> dict:
    """Build the frozen summary only from the three validated record collections."""
